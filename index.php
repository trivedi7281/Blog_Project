                ...
                <header class="topbar">
                    <div class="container flex justify-between item-center">
                        ...
                        <div class="auth flex item-center">
                            <div class="username">
                                <img src="./icons/023-man.svg" alt="">
                                <span>Welcome <a href="#">User Name</a> !</span>
                            </div>
                            <span class="divider">|</span>
                            <div class="logout">
                                <img src="./icons/029-log-out.svg" alt="">
                                <a href="#">Logout</a>
                            </div>
                            <span class="divider">|</span>
                            <div class="login">
                                <img src="./icons/030-login-1.svg" alt="">
                                <a href="./login.html">Log In</a>
                            </div>
                            <span class="divider">|</span>
                            <div class="register">
                                <img src="./icons/044-edit-1.svg" alt="">
                                <a href="./register.html">Register Now</a>
                            </div>
                            <span class="divider">|</span>
                            <div class="language">
                                <img src="./icons/002-language.svg" alt="">
                        ...
                        <div class="slider">
                            ...
                            <div class="food-slider">
                                <div class="food-card magic-shadow-sm">
                                    ...
                                    <hr>
                                    <div>
                                        <h2 class="text-center"><a href="">Why should all boys have fun!!! some more text to test the Box <span>...</span></a></h2>
                                    </div>
                                </div>
                                <div class="food-card magic-shadow-sm">
                                    <div class="product-image flex item-center justify-center">
